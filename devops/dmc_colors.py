#!/usr/bin/env python3
"""
DMC Embroidery Thread Colour Database
...
DMC_COLORS: list[DMCColor] = [
    ...
    {'code': '963', 'name': 'Dusty Rose Ultra Very Light', 'hex': '#FFD7D7', 'rgb': (255, 215, 215), 'symbol': 'V'},
    {'code': '3716', 'name': 'Dusty Rose Medium Very Light', 'hex': '#FFBDBD', 'rgb': (255, 189, 189), 'symbol': 'W'},
    ...
    {'code': '150', 'name': 'Dusty Rose Ultra Very Dark', 'hex': '#AB0249', 'rgb': (171, 2, 73), 'symbol': 'o'},
    ...
    {'code': '225', 'name': 'Shell Pink Ultra Very Light', 'hex': '#FFDFD5', 'rgb': (255, 223, 213), 'symbol': '.'},
    {'code': '224', 'name': 'Shell Pink Very Light', 'hex': '#EBB7AF', 'rgb': (235, 183, 175), 'symbol': '/'},
    {'code': '152', 'name': 'Shell Pink Medium Light', 'hex': '#E2A099', 'rgb': (226, 160, 153), 'symbol': ':'},
    ...
    {'code': '778', 'name': 'Antique Mauve Very Light', 'hex': '#DFB3BB', 'rgb': (223, 179, 187), 'symbol': '@'},
    ...
    {'code': '315', 'name': 'Antique Mauve Medium Dark', 'hex': '#814952', 'rgb': (129, 73, 82), 'symbol': '_'},
    {'code': '3802', 'name': 'Antique Mauve Very Dark', 'hex': '#714149', 'rgb': (113, 65, 73), 'symbol': '`'},
    {'code': '902', 'name': 'Garnet Very Dark', 'hex': '#822637', 'rgb': (130, 38, 55), 'symbol': '{'},
    {'code': '3743', 'name': 'Antique Violet Very Light', 'hex': '#D7CBD3', 'rgb': (215, 203, 211), 'symbol': '|'},
    {'code': '3042', 'name': 'Antique Violet Light', 'hex': '#B79DA7', 'rgb': (183, 157, 167), 'symbol': '}'},
    {'code': '3041', 'name': 'Antique Violet Medium', 'hex': '#956F7C', 'rgb': (149, 111, 124), 'symbol': '~'},
    ...
    {'code': '3747', 'name': 'Blue Violet Very Light', 'hex': '#D3D7ED', 'rgb': (211, 215, 237), 'symbol': '²'},
    {'code': '341', 'name': 'Blue Violet Light', 'hex': '#B7BFDD', 'rgb': (183, 191, 221), 'symbol': '³'},
    {'code': '156', 'name': 'Blue Violet Medium Light', 'hex': '#A3AED1', 'rgb': (163, 174, 209), 'symbol': '´'},
    {'code': '340', 'name': 'Blue Violet Medium', 'hex': '#ADA7C7', 'rgb': (173, 167, 199), 'symbol': 'µ'},
    {'code': '155', 'name': 'Blue Violet Medium Dark', 'hex': '#9891B6', 'rgb': (152, 145, 182), 'symbol': '¶'},
    ...
    {'code': '157', 'name': 'Cornflower Blue Very Light', 'hex': '#BBC3D9', 'rgb': (187, 195, 217), 'symbol': '¹'},
    {'code': '794', 'name': 'Cornflower Blue Light', 'hex': '#8F9CC1', 'rgb': (143, 156, 193), 'symbol': 'º'},
    {'code': '793', 'name': 'Cornflower Blue Medium', 'hex': '#707DA2', 'rgb': (112, 125, 162), 'symbol': '»'},
    ...
    {'code': '158', 'name': 'Cornflower Blue Medium Very Dark', 'hex': '#4C526E', 'rgb': (76, 82, 110), 'symbol': '¾'},
    {'code': '791', 'name': 'Cornflower Blue Very Dark', 'hex': '#464563', 'rgb': (70, 69, 99), 'symbol': '¿'},
    ...
    {'code': '3845', 'name': 'Turquoise Bright Medium', 'hex': '#04C4CA', 'rgb': (4, 196, 202), 'symbol': 'Ô'},
    ...
    {'code': '3756', 'name': 'Baby Blue Ultra Very Light', 'hex': '#EEFCFC', 'rgb': (238, 252, 252), 'symbol': 'Ù'},
    ...
    {'code': '803', 'name': 'Baby Blue Ultra Very Dark', 'hex': '#2C597C', 'rgb': (44, 89, 124), 'symbol': 'á'},
    ...
    {'code': '3753', 'name': 'Antique Blue Ultra Very Light', 'hex': '#DBE2E9', 'rgb': (219, 226, 233), 'symbol': 'å'},
    {'code': '3752', 'name': 'Antique Blue Very Light', 'hex': '#C7D1DB', 'rgb': (199, 209, 219), 'symbol': 'æ'},
    ...
    {'code': '311', 'name': 'Wedgewood Ultra Very Dark', 'hex': '#1C5066', 'rgb': (28, 80, 102), 'symbol': 'ò'},
    {'code': '747', 'name': 'Peacock Blue Very Light', 'hex': '#E5FCFD', 'rgb': (229, 252, 253), 'symbol': 'ó'},
    ...
    {'code': '3765', 'name': 'Peacock Blue Very Dark', 'hex': '#347F8C', 'rgb': (52, 127, 140), 'symbol': '÷'},
    ...
    {'code': '3808', 'name': 'Turquoise Ultra Very Dark', 'hex': '#366970', 'rgb': (54, 105, 112), 'symbol': 'ý'},
    ...
    {'code': '3818', 'name': 'Emerald Green Ultra Very Dark', 'hex': '#115A3B', 'rgb': (17, 90, 59), 'symbol': 'Ĩ'},
    {'code': '369', 'name': 'Pistachio Green Very Light', 'hex': '#D7EDCC', 'rgb': (215, 237, 204), 'symbol': 'ĩ'},
    ...
    {'code': '319', 'name': 'Pistachio Green Very Dark', 'hex': '#205F2E', 'rgb': (32, 95, 46), 'symbol': 'ĭ'},
    {'code': '890', 'name': 'Pistachio Green Ultra Very Dark', 'hex': '#174923', 'rgb': (23, 73, 35), 'symbol': 'Į'},
    ...
    {'code': '772', 'name': 'Yellow Green Very Light', 'hex': '#E4ECD4', 'rgb': (228, 236, 212), 'symbol': 'Ĵ'},
    ...
    {'code': '472', 'name': 'Avocado Green Ultra Light', 'hex': '#D8E498', 'rgb': (216, 228, 152), 'symbol': 'ń'},
    {'code': '471', 'name': 'Avocado Green Very Light', 'hex': '#AEBF79', 'rgb': (174, 191, 121), 'symbol': 'Ņ'},
    ...
    {'code': '166', 'name': 'Moss Green Medium Light', 'hex': '#C0C840', 'rgb': (192, 200, 64), 'symbol': 'Ř'},
    ...
    {'code': '834', 'name': 'Golden Olive Very Light', 'hex': '#DBBE7F', 'rgb': (219, 190, 127), 'symbol': 'Ŧ'},
    ...
    {'code': '869', 'name': 'Hazelnut Brown Very Dark', 'hex': '#835E39', 'rgb': (131, 94, 57), 'symbol': 'Ź'},
    ...
    {'code': '3078', 'name': 'Golden Yellow Very Light', 'hex': '#FDF9CD', 'rgb': (253, 249, 205), 'symbol': '┋'},
    ...
    {'code': '3856', 'name': 'Mahogany Ultra Very Light', 'hex': '#FFD3B5', 'rgb': (255, 211, 181), 'symbol': '┢'},
    ...
    {'code': '3771', 'name': 'Terra Cotta Ultra Very Light', 'hex': '#F4BBA9', 'rgb': (244, 187, 169), 'symbol': '┾'},
    {'code': '758', 'name': 'Terra Cotta Very Light', 'hex': '#EEAA9B', 'rgb': (238, 170, 155), 'symbol': '┿'},
    ...
    {'code': '3779', 'name': 'Rosewood Ultra Very Light', 'hex': '#F8CAC8', 'rgb': (248, 202, 200), 'symbol': '╅'},
    ...
    {'code': '3774', 'name': 'Desert Sand Very Light', 'hex': '#F3E1D7', 'rgb': (243, 225, 215), 'symbol': '╉'},
    ...
    {'code': '632', 'name': 'Desert Sand Ultra Very Dark', 'hex': '#875539', 'rgb': (135, 85, 57), 'symbol': '╏'},
    ...
    {'code': '543', 'name': 'Beige Brown Ultra Very Light', 'hex': '#F2E3CE', 'rgb': (242, 227, 206), 'symbol': '╢'},
    ...
    {'code': '3024', 'name': 'Brown Gray Very Light', 'hex': '#EBEAE7', 'rgb': (235, 234, 231), 'symbol': '╱'},
    ...
    {'code': '3033', 'name': 'Mocha Brown Very Light', 'hex': '#E3D8CC', 'rgb': (227, 216, 204), 'symbol': '╵'},
    ...
    {'code': '3866', 'name': 'Mocha Brown Ultra Very Light', 'hex': '#FAF6F0', 'rgb': (250, 246, 240), 'symbol': '╺'},
    {'code': '842', 'name': 'Beige Brown Very Light', 'hex': '#D1BAA1', 'rgb': (209, 186, 161), 'symbol': '╻'},
    ...
    {'code': '3072', 'name': 'Beaver Gray Very Light', 'hex': '#E6E8E8', 'rgb': (230, 232, 232), 'symbol': '▀'},
    ...
    {'code': '10', 'name': 'Tender Green Very Light', 'hex': '#EDFED9', 'rgb': (237, 254, 217), 'symbol': '▙'},
    ...
    {'code': '13', 'name': 'Nile Green Medium Light', 'hex': '#BFF6E0', 'rgb': (191, 246, 224), 'symbol': '▜'},
    ...
    {'code': '19', 'name': 'Autumn Gold Medium Light', 'hex': '#F7C95F', 'rgb': (247, 201, 95), 'symbol': '▢'},
...
def color_distance(rgb1: tuple[int, int, int], rgb2: tuple[int, int, int]) -> float:
    """
    Calculate perceptual colour distance using weighted Euclidean formula.
...
def find_closest_dmc_with_distance(rgb: tuple[int, int, int]) -> tuple[DMCColor, float]:
    """Find the closest DMC colour with distance information."""
    closest = DMC_COLORS[0]
    min_dist = float("inf")
    for dmc in DMC_COLORS:
        dist = color_distance(rgb, dmc["rgb"])
...
def find_closest_dmc_colors(rgb: tuple[int, int, int], count: int = 5) -> list[tuple[DMCColor, float]]:
    """Find N closest DMC colours to a given RGB value."""
    distances = [(dmc, color_distance(rgb, dmc["rgb"])) for dmc in DMC_COLORS]
    distances.sort(key=lambda x: x[1])
    return distances[:count]


def search_by_name(query: str) -> list[DMCColor]:
    """Search colours by partial name match."""
    lower_query = query.lower()
    return [c for c in DMC_COLORS if lower_query in c["name"].lower()]


def get_color_family(family: str) -> list[DMCColor]:
    """Get all colours in a colour family (based on name keywords)."""
    lower_family = family.lower()
    return [c for c in DMC_COLORS if lower_family in c["name"].lower()]


def find_dmc(query: str) -> Optional[DMCColor]:
    """Universal lookup: attempts to find colour by code, hex, name, or symbol."""
    return find_by_code(query) or find_by_hex(query) or find_by_name(query) or find_by_symbol(query)
...
def get_all_symbols() -> list[str]:
    ...
    return [c["symbol"] for c in DMC_COLORS]


def get_all_codes() -> list[str]:
    """Get all available codes."""
    return [c["code"] for c in DMC_COLORS]
