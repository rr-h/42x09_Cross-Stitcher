...
// Standard colors used in cross-stitch patterns
...
// Complete DMC color palette - 454 standard colors
...
// Calculate color distance using weighted Euclidean distance (approximates human perception)
export function colorDistance(rgb1: [number, number, number], rgb2: [number, number, number]): number {
  ...
  // Weighted distance formula that better matches human perception
...
// Pre-compute DMC colors as RGB for faster lookups
export const DMC_COLORS_RGB: Array<{ color: DMCColor; rgb: [number, number, number] }> =
