...
export function createInitialProgress(pattern: PatternDoc): UserProgress {
...
export function checkCompletion(_pattern: PatternDoc, paletteCounts: PaletteCounts[]): boolean {
...
export const useGameStore = create<GameState>((set, get) => {
  ...
  return {
    ...
    loadPattern: async (pattern: PatternDoc) => {
      // Save pattern to IndexedDB so it can be reloaded later
